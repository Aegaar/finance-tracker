-- CreateEnum
CREATE TYPE "IncomeSource" AS ENUM ('SALARY', 'FREELANCING', 'INVESTMENTS', 'STOCKS', 'BANK_TRANSFERS', 'OTHER');

-- CreateEnum
CREATE TYPE "ExpenseSource" AS ENUM ('EDUCATION', 'GROCERIES', 'HEALTH', 'SUBSCRIPTIONS', 'CLOTHING', 'TRAVELING', 'OTHER');
...
CREATE TABLE "Income" (
    ...
    "source" "IncomeSource" NOT NULL DEFAULT 'SALARY',
...
CREATE TABLE "Expense" (
    ...
    "amount" INTEGER NOT NULL,
    "description" TEXT NOT NULL,
    "source" "ExpenseSource" NOT NULL DEFAULT 'GROCERIES',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "userEmail" TEXT NOT NULL,
